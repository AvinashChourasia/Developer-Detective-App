...
function updateProfile(data) {
  if (data.message !== "Not Found") {
    ...
    linkedin.innerText = checkNull(data.linkedin_username, linkedin) ? data.linkedin_username : "Not Available";
    linkedin.href = checkNull(data.linkedin_username, linkedin) ? `https://twitter.com/${data.linkedin_username}` : "#";
...
function darkModeProperties() {
  root.setProperty("--lm-bg", "#24272c");
  root.setProperty("--lm-bg-content", "#393c43");
